  ...
  >
    ...
    >
      <div>
        <img
          ...
          :src="data?.agency_wizard.website_details.logo || '/icons/logo.svg'"
          alt="agency_ai_logo"
        />
      </div>
      <nav class="nav-desktop">
        <ul
          class="header_three flex items-center lg:space-x-8 space-x-4 text-[#333]"
        >
          <NuxtLink
            to="#quote"
    ...
    <transition name="slide-fade" mode="out-in">
      <aside class="nav-mobile" v-if="mobileNavOpen" key="mobileNav">
        <div class="mb-12">
          <img class="w-[120px]" :src="data?.agency_wizard.website_details.logo || '/icons/logo.svg'" alt="agency_ai_logo" />
        </div>
        <nav>
          <ul
            class="header_three flex items-start flex-col space-y-6 text-[#333]"
          >
            <NuxtLink
